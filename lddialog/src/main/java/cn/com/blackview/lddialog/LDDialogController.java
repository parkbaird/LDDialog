...
import cn.com.blackview.lddialog.manager.ScreenUtil;
...
public class LDDialogController {
    ...
    LDDialogController(IDialog dialog) {
    ...
    public static class LDParams {
        ...
        void apply(LDDialogController controller) {
