...
public class LDDialog extends LDBaseDialog implements IDialog {

    private Context context;
    private LDDialogController controller;
    ...
    public LDDialog() {
        controller = new LDDialogController(this);
    }
    ...
    public static class Builder {
        private LDDialogController.LDParams params;
        private IDialog.OnBuildListener buildListener;
        private IDialog.OnDismissListener dismissListener;
        ...
        public Builder(Context context) {
            ...
            params = new LDDialogController.LDParams();
        ...
        private LDDialog create() {
            LDDialog dialog = new LDDialog();
